...
const services = [
  ...
  },
  {
    ...
    description:
      "Full decor for birthdays, puberty functions, housewarmings, and corporate functions, with themed setups designed to fit the occasion.",
    ...
    <>
      ...
      <div>
        {services.map((service, index) => (
          <section
            key={service.title}
            className={`py-20 sm:py-28 ${index % 2 === 1 ? "section-dark glow-dark" : ""}`}
          >
          <Container>
            <div
            ...
            >
              ...
              <Reveal direction={index % 2 === 1 ? "right" : "left"}>
                <div>
                  ...
                  <h2 className="mt-4 font-display text-3xl sm:text-4xl font-semibold text-text">
                    {service.title}
                  </h2>
                  ...
                  <ul className="mt-6 space-y-2">
                    {service.points.map((point) => (
                      <li key={point} className="flex items-center gap-3 text-sm text-text/80">
